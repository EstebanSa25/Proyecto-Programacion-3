...
<div onclick='Mostrar_compañeros(`rsf_Companeros_clase.php`,".$fila['Id_usuario'].",".$fila['Id_asignatura'].",`".$fila['Dia']."`,".$fila['Id_nivel'].",`".$fila['Aula']."`);' class='eventWrapper'>
	<div class='event'>
		<div class='event--img'>
			<a href='#' onclick='Mostrar_compañeros(`rsf_Companeros_clase.php`,".$fila['Id_usuario'].",".$fila['Id_asignatura'].",`".$fila['Dia']."`,".$fila['Id_nivel'].",`".$fila['Aula']."`);' class='w-fancybox'>
			</a>
            <img src='http://localhost/ProyectoProgramacion3/SVG/logo-color.svg' title='Ver mis compañeros de ".$fila['Nombre']."' onclick='Mostrar_compañeros(`rsf_Companeros_clase.php`,".$fila['Id_usuario'].",".$fila['Id_asignatura'].",`".$fila['Dia']."`,".$fila['Id_nivel'].",`".$fila['Aula']."`);'>
		</div>
		...
		<div class='event--content'>
			<h2><a href='#' onclick='Mostrar_compañeros(`rsf_Companeros_clase.php`,".$fila['Id_usuario'].",".$fila['Id_asignatura'].",`".$fila['Dia']."`,".$fila['Id_nivel'].",`".$fila['Aula']."`);'  title='Ver mis compañeros de ".$fila['Nombre']."'>".$fila['Nombre']."</a></h2>
